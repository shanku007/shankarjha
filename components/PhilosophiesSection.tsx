        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {philosophies.map((philosophy, index) => {
            ...
            return (
              ...
              >
                <CardHeader>
                  <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-violet-400/10 to-purple-400/10 rounded-bl-full group-hover:opacity-20 transition-opacity"></div>
                  <div className="flex items-center gap-3 relative z-10">
                    <div className="p-2 rounded-lg bg-gradient-to-r from-violet-100 to-purple-100 group-hover:from-violet-200 group-hover:to-purple-200 transition-all">
                      <Icon className="h-5 w-5 text-violet-600" />
                    </div>
                    <CardTitle className="text-xl flex items-center gap-2">
                      <span className="w-1 h-6 bg-gradient-to-b from-violet-600 to-purple-600 rounded-full"></span>
                      {philosophy.title}
                    </CardTitle>
                  </div>
                </CardHeader>
